...
class LocalizationService {
  ...
  static const Map<String, Map<String, String>> translations = {
    'id': {
      ...
      'posko_faskes': 'Posko &\nFaskes',
      'posko_faskes_sub': 'Lokasi posko & fasilitas',
      'ask_sigumi': 'Tanya\nSi Gumi',
      'ask_sigumi_sub': 'AI asisten mitigasi',
      'emergency_number': 'Nomor\nDarurat',
      'emergency_number_sub': 'Hubungi bantuan darurat',
      'latest_news': 'Berita Terkini',
      'loading_news': 'Memuat berita...',
      'no_news': 'Belum ada berita',
      'explore_tourism': 'Jelajahi Wisata',
      'tourism_section': 'Pariwisata',
      'tourism_subtitle': 'Destinasi wisata alam & budaya aman',
      'hiking_tracking_section': 'Tracking Pendakian',
      'hiking_subtitle': 'Panduan rute & kesiapan jalur aman',
      'main_menu_subtitle': 'Layanan terpadu mitigasi bencana',
    ...
    'en': {
      ...
      'posko_faskes': 'Post &\nClinic',
      'posko_faskes_sub': 'Posts & medical facilities',
      'ask_sigumi': 'Ask\nSi Gumi',
      'ask_sigumi_sub': 'AI mitigation assistant',
      'emergency_number': 'Emergency\nNumbers',
      'emergency_number_sub': 'Contact emergency services',
      'latest_news': 'Latest News',
      'loading_news': 'Loading news...',
      'no_news': 'No news yet',
      'explore_tourism': 'Explore Tourism',
      'tourism_section': 'Tourism',
      'tourism_subtitle': 'Safe natural & cultural destinations',
      'hiking_tracking_section': 'Hiking Tracking',
      'hiking_subtitle': 'Route guide & safe trail readiness',
      'main_menu_subtitle': 'Disaster mitigation & emergency services',
    ...
    'jv': {
      ...
      'tourism_section': 'Pariwisata',
      'tourism_subtitle': 'Papan wisata alam & budaya aman',
      'hiking_tracking_section': 'Tracking Pendakian',
      'hiking_subtitle': 'Panduan rute & navigasi dalan aman',
      'main_menu_subtitle': 'Layanan terpadu mitigasi bencana',
    ...
    'ba': {
      ...
      'explore_tourism': 'Jelajah Wisata',
      'tourism_section': 'Pariwisata',
      'tourism_subtitle': 'Genah wisata alam & budaya becik',
      'hiking_tracking_section': 'Tracking Pendakian',
      'hiking_subtitle': 'Panduan rute & navigasi margi becik',
      'main_menu_subtitle': 'Layanan terpadu mitigasi bencana',
    ...
    'sa': {
      ...
      'tourism_subtitle': 'Papan wisata alam & budaya aman',
      'hiking_tracking_section': 'Tracking Pendakian',
      'hiking_subtitle': 'Panduan rute & navigasi lalan aman',
      'main_menu_subtitle': 'Layanan terpadu mitigasi bencana',
      'latest_news_subtitle': 'Informasi resmi & aktivitas paling anyar',
      'find_destination': 'Golek destinasi & agenda budaya',
      'select_region': 'Pilih Daerah',
