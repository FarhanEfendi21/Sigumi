  ...
  static List<EvacuationRoute> mockRoutes() {
    return [
      EvacuationRoute(
        ...
        description:
            'Melalui Jl. Kaliurang → Jl. Ring Road Utara → Stadion Maguwoharjo. Jalur utama dengan akses kendaraan lebar.',
        distance: 18.5,
        estimatedMinutes: 35,
        safetyScore: 0.92,
      ...
      EvacuationRoute(
        ...
        description:
            'Melalui Jl. Magelang → Sleman Kota. Jalur alternatif jika jalur selatan padat.',
        distance: 22.0,
        estimatedMinutes: 45,
        safetyScore: 0.85,
      ...
      EvacuationRoute(
        ...
        description:
            'Melalui Dukun → Sawangan → Muntilan. Cocok untuk warga lereng timur.',
        distance: 15.0,
        estimatedMinutes: 30,
        safetyScore: 0.78,
        congestionLevel: 'Rendah',
      ...
      EvacuationRoute(
        ...
        description:
            'Melalui Cangkringan → Kalasan → Prambanan. Jalur evakuasi zona tenggara.',
        distance: 25.0,
        estimatedMinutes: 50,
        safetyScore: 0.72,
