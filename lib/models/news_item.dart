  ...
  static List<NewsItem> mockNews() {
    ...
    return [
      NewsItem(
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=1000&auto=format&fit=crop', // Volcano illustration / visual
      ),
      NewsItem(
        id: 'news_002',
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1579203666245-c40590a369da?w=800&auto=format&fit=crop&q=60', // Seismograph vibe
      ),
      NewsItem(
        id: 'news_003',
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1627997576208-a5ad3fac18a1?w=800&auto=format&fit=crop&q=60', // Mountain landscape
      ),
      NewsItem(
        id: 'news_004',
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1510425442657-375cb47eb797?w=800&auto=format&fit=crop&q=60', // Emergency / Community
      ),
      NewsItem(
        id: 'news_005',
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1502481851512-e9e2529bfbf9?w=800&auto=format&fit=crop&q=60', // Weather
      ),
    ];
  }
}
