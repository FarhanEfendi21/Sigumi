  ...
  static final List<Map<String, dynamic>> childrenTopics = [
    {
      'emoji': '🌋',
      'title': 'Apa itu Gunung Berapi?',
      'intro': 'Gunung berapi adalah gunung yang *sangat istimewa*, yang bisa *batuk besar*!',
      'bullets': [
        'Di dalam perut gunung ada batuan sangat panas bernama *magma*.',
        'Saat keluar, namanya berubah menjadi *lava*.',
        'Tanahnya *sangat subur*, makanya banyak petani di sekitarnya.',
      ],
      'color': Colors.orange,
      'tip': 'Meskipun subur, kita tetap harus *hati-hati* saat berada di dekat gunung ya!',
    },
    {
      'emoji': '⚠️',
      'title': 'Tanda-tanda Bahaya',
      'intro': 'Gunung akan selalu *memberi tanda* sebelum dia batuk. Segera beritahu orang dewasa kalau kamu:',
      'bullets': [
        'Merasakan tanah *bergetar* (gempa kecil).',
        'Mendengar suara keras *"GRRRR"* dari arah gunung.',
        'Mencium bau seperti *telur busuk* (gas belerang).',
        'Melihat hewan-hewan *turun gunung* berhamburan.',
      ],
      'color': Colors.red,
      'tip': 'Burung dan hewan hutan *lebih peka* terhadap bahaya. Kalau mereka panik, itu pertanda peringatan.',
    },
    {
      'emoji': '🏃',
      'title': 'Apa yang Harus Dilakukan?',
      'intro': 'Kalau ada peringatan dari kakak-kakak petugas, ikuti *langkah jitu* ini:',
      'bullets': [
        '*Jangan panik!* Ambil napas yang dalam.',
        '*Ikuti arahan* Ayah, Ibu, atau Guru.',
        'Lari cepat *menjauhi* arah gunung.',
        'Gunakan *masker* atau tutup hidung dengan kain.',
        'Lindungi kepalamu dengan *tas* atau *helm*.',
      ],
      'color': Colors.blue,
      'tip': 'Hal yang paling penting adalah *keselamatanmu*, bukan mainanmu!',
    },
    {
      'emoji': '🎒',
      'title': 'Tas Siaga Cilik',
      'intro': 'Kamu bisa bantu Ayah dan Ibu dengan menyiapkan *Tas Siagamu* sendiri:',
      'bullets': [
        '*Air minum* dan makanan ringan favoritmu.',
        'Satu set *baju ganti* dan jaket.',
        '*Senter kecil* dan *Masker*.',
        '*Mainan* atau boneka kesayanganmu.',
      ],
      'color': Colors.green,
      'tip': 'Pasang kertas daftar periksa (*checklist*) di depan tas, agar tidak ada yang tertinggal.',
    },
    {
      'emoji': '📞',
      'title': 'Nomor Penting',
      'intro': 'Kalau terpisah dari Ayah dan Ibu, kamu bisa minta tolong dengan cara:',
      'bullets': [
        'Hafalkan *Nomor HP Ayah & Ibu*.',
        'Ingat *117* untuk hubungi tim penanggulangan (BNPB).',
        'Ingat *115* untuk panggil Kakak-Kakak Basarnas.',
      ],
      'color': Colors.purple,
      'tip': 'Tulis *nomor telepon* di kertas kecil dan masukkan ke saku celana atau tasmu!',
    },
    {
      'emoji': '🤝',
      'title': 'Jadi Pahlawan Temanmu',
      'intro': 'Pahlawan sejati membantu teman saat sedang kesulitan!',
      'bullets': [
        'Berikan senyum dan bilang *"Semua akan baik-baik saja"*.',
        '*Pegang tangan* temanmu yang sedang ketakutan.',
        '*Teriak keras* minta tolong ke orang dewasa jika temanmu terluka.',
      ],
      'color': Colors.teal,
      'tip': 'Berbagi cerita setelah bersembunyi akan membantu menghilangkan *rasa takutmu*.',
    },
  ];
